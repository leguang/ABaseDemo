package cn.itsite.abase.demo.bluetooth.classic;
...
public class ClassicBluetooth implements IBluetooth {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                Log.e(TAG,"Discovery finished: " + mDevices.size());
                mContext.unregisterReceiver(mReceiver);
                if (mListener != null) {
    ...
    private class ConnectThread extends Thread {
                ...
                Observable.just("1")
                        ...
                        .subscribe(new Action1<String>() {
                            ...
                            public void call(String receiveData) {
                                Log.e(TAG,"currentThreadName::" + Thread.currentThread().getName());
        ...
        public void run() {
            ...
            mBluetoothAdapter.cancelDiscovery();
            try {
                Log.e(TAG,"开始阻塞的方式进行连接");
                if (mmSocket != null) {
                    mmSocket.connect();
                }
                Log.e(TAG,"结束阻塞的方式进行连接");
            } catch (IOException e) {
                e.printStackTrace();
                try {
                    mmSocket.close();
...
//                    String readMessage1 = new String(readMessage.getBytes("GBK"), "UTF-8");
        ...
        public void write(byte[] buffer) {
            try {
                ...
                Log.e(TAG,"write::" + new String(buffer));
            } catch (IOException e) {
                e.printStackTrace();
